public abstract class EstructuraDeDatos {
    ...
    // Método abstracto para insertar un valor
    public abstract void insertar(Object valor);

    // Método abstracto para eliminar un valor
    public abstract void eliminar(Object valor);
